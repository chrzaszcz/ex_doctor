...
- [`:tr`](https://hexdocs.pm/erlang_doctor/0.3.2/tr.html) is the main module of [Erlang Doctor](https://hex.pm/packages/erlang_doctor), which provides all the functionality.
...
There is also `:tr.start/1`, which accepts a [map of options](https://hexdocs.pm/erlang_doctor/0.3.2/tr.html#t:init_options/0), including:
...
The `:tr.trace/1` function also accepts a [map of options](https://hexdocs.pm/erlang_doctor/0.3.2/tr.html#t:trace_options/0), which include:
...
```elixir
iex(25)> :tr.print_sorted_call_stat(fn tr(data: [n]) when is_integer(n) -> n end, %{limit: 3})
3  1  7981  1991
2  1  5990  1993
1  1  3997  1994
:ok
