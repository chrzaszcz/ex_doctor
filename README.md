...
- [`:tr`](https://hexdocs.pm/erlang_doctor/0.2.8/tr.html) is the main module of [Erlang Doctor](https://hex.pm/packages/erlang_doctor), which provides all the functionality.
...
The `:tr.trace/1` function also accepts a [map of options](https://hexdocs.pm/erlang_doctor/0.2.8/tr.html#t:trace_options/0), which include:
